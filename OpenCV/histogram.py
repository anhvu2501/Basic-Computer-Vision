...
# Compute Grayscale Histogram with a mask
# Create a mask
...
gray_hist_wmask = cv.calcHist([gray], [0], mask, [256], [0, 256])

plt.figure()
plt.title('Grayscale with Mask Histogram')
plt.xlabel('Bins')
plt.ylabel('# of pixels')
plt.plot(gray_hist_wmask)
plt.xlim([0, 255])
plt.show()
